...
function mortgageCalculatorTwo(principal, interest, years) {
...
// 🏡 Task 5: Conditionals
/* Add another paramater to your function called credit score. This parameter will be a number between 0 and 800 (a credit score).

Then, add control flow within your function such that IF creditScore is above 740, interest rate drops by 0.5%, if credit score is below 660, interest rate increases by 0.5% and if credit score is anywhere between 660 and 740 interest rate doesn't change.
*/
function mortgageCalculatorThree(principal, interest, years, creditScore) {
    monthlyRate = mortgageCalculatorTwo(principal, interest, years)
    /*let monthlyInterestRate = interest/12;
    let periods = years * 12;
    let monthlyRate = (principal * (monthlyInterestRate * Math.pow(1 + monthlyInterestRate, periods)) / (Math.pow( 1 + monthlyInterestRate, periods) -1 ));*/
    ...
    console.log(mortgageCalculatorThree(200000, 0.05, 30, 800));
